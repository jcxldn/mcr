...
RUN java -Xshare:dump \
	...
	&& JDEPS=jdk.zipfs,jdk.crypto.ec,java.scripting,jdk.management,$(jdeps --ignore-missing-deps --list-deps --multi-release 15 app.jar 2.app.jar | awk -F'/' '{print $1}' | tr -d '[[:blank:]]' | sed ':a;N;$!ba;s/\n/,/g') \
